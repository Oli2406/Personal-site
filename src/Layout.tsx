...
export default function Layout() {
    return (
        <div
            ...
            <header
                className="sticky top-0 z-50 w-full flex items-center justify-between bg-indigo-700 backdrop-blur-md border-b border-white/20 shadow-lg px-8 py-4 text-2xl font-semibold">
