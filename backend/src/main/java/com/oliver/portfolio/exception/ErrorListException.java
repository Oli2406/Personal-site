...
public abstract class ErrorListException extends Exception {
  ...
  public ErrorListException(
      String errorListDescriptor, String messageSummary, List<String> errors) {
   ...
   *
   * <p>Note: this implementation produces the message from the {@link #summary} and the list of
   * {@link #errors}
   */
  @Override
  public String getMessage() {
    return "%s. %s: %s.".formatted(messageSummary, errorListDescriptor,
        String.join(", ", errors));
  }
